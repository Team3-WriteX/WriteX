            ...
            <li class="bg-dark-30 restaurant-page-header bg-dark" style="background-image:url(&quot;assets/images/restaurant/slider1.jpg&quot;);">
              <div class="titan-caption">
                <div class="caption-content">
                  ...
                  <div class="font-alt mb-40 titan-title-size-4">Professional & Academic Writing Made Easy!</div><a class="section-scroll btn btn-border-w btn-round" href="#menu">Request For a Quote</a>
                </div>
              </div>
            </li>
            ...
            <li class="bg-dark-30 restaurant-page-header bg-dark" style="background-image:url(&quot;assets/images/restaurant/slider3.jpg&quot;);">
              <div class="titan-caption">
                <div class="caption-content">
                  ...
                  <div class="font-alt mb-40 titan-title-size-3">our services</div><a class="section-scroll btn btn-border-w btn-round" href="#specialities">Learn More</a>
                </div>
              </div>
            </li>
          </ul>
